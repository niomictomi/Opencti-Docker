...
4. Bauat stack pada Portainer, dengan menggunakan file ```docker-compose.yml```.
   <p align="center">
    ...
    <img src="https://github.com/niomictomi/Opencti-Docker/blob/master/file/stack-docker-compose.png" width="600"></a></p>
5. Setting environment berdasarkan file ```.env```.
   <p align="center">
    <a href="https://github.com/niomictomi/Opencti-Docker" target="_blank">
    <img src="https://github.com/niomictomi/Opencti-Docker/blob/master/file/environment.png" width="600"></a></p>
...
7. Setelah proses selesai, buk browser dan akses ```alamat-ip:8080``` dan OPENCTI akan tampil pada halaman tersebut.
   <p align="center">
    <a href="https://github.com/niomictomi/Opencti-Docker" target="_blank">   
    <img src="https://github.com/niomictomi/Opencti-Docker/blob/master/file/opencti.png" width="600"></a></p>
